...
const About = () => {
    return (
        <div>
            <h2 className='text-center mt-20 text-white font-mono text-3xl font-bold'>Services we Provide!</h2>
            <div className='grid grid-cols-1 md:grid-cols-4 w-10/12 mx-auto mt-10 mb-32 font-mono ml-10 md:ml-40 text-white'>
                <div className='mb-4'>
